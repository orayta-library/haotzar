...
pdfjs-presentation-mode-button =
    .title = מעבר למסך מלא
pdfjs-presentation-mode-button-label = מסך מלא
...
pdfjs-spread-none-button =
    .title = לא לצרף עמודים
pdfjs-spread-none-button-label = ללא עמודים
pdfjs-spread-odd-button =
    .title = צירוף עמודים שמתחילים בדפים עם מספרים אי־זוגיים
pdfjs-spread-odd-button-label = עמודים אי־זוגיים
pdfjs-spread-even-button =
    .title = צירוף עמודים שמתחילים בדפים עם מספרים זוגיים
pdfjs-spread-even-button-label = עמודים זוגיים
